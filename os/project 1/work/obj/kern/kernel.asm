...
f0100494:	e8 3b 10 00 00       	call   f01014d4 <memmove>
...
f0100648:	e8 ea 02 00 00       	call   f0100937 <cprintf>
}
...
f010069d:	e8 95 02 00 00       	call   f0100937 <cprintf>
f01006a2:	c7 44 24 08 a4 1c 10 	movl   $0xf0101ca4,0x8(%esp)
f01006a9:	f0 
f01006aa:	c7 44 24 04 2c 1c 10 	movl   $0xf0101c2c,0x4(%esp)
f01006b1:	f0 
f01006b2:	c7 04 24 23 1c 10 f0 	movl   $0xf0101c23,(%esp)
f01006b9:	e8 79 02 00 00       	call   f0100937 <cprintf>
	return 0;
}
...
f01006d2:	e8 60 02 00 00       	call   f0100937 <cprintf>
	cprintf("  _start                  %08x (phys)\n", _start);
f01006d7:	c7 44 24 04 0c 00 10 	movl   $0x10000c,0x4(%esp)
f01006de:	00 
f01006df:	c7 04 24 cc 1c 10 f0 	movl   $0xf0101ccc,(%esp)
f01006e6:	e8 4c 02 00 00       	call   f0100937 <cprintf>
	cprintf("  entry  %08x (virt)  %08x (phys)\n", entry, entry - KERNBASE);
f01006eb:	c7 44 24 08 0c 00 10 	movl   $0x10000c,0x8(%esp)
f01006f2:	00 
f01006f3:	c7 44 24 04 0c 00 10 	movl   $0xf010000c,0x4(%esp)
f01006fa:	f0 
f01006fb:	c7 04 24 f4 1c 10 f0 	movl   $0xf0101cf4,(%esp)
f0100702:	e8 30 02 00 00       	call   f0100937 <cprintf>
	cprintf("  etext  %08x (virt)  %08x (phys)\n", etext, etext - KERNBASE);
f0100707:	c7 44 24 08 17 19 10 	movl   $0x101917,0x8(%esp)
f010070e:	00 
f010070f:	c7 44 24 04 17 19 10 	movl   $0xf0101917,0x4(%esp)
f0100716:	f0 
f0100717:	c7 04 24 18 1d 10 f0 	movl   $0xf0101d18,(%esp)
f010071e:	e8 14 02 00 00       	call   f0100937 <cprintf>
	cprintf("  edata  %08x (virt)  %08x (phys)\n", edata, edata - KERNBASE);
f0100723:	c7 44 24 08 00 23 11 	movl   $0x112300,0x8(%esp)
f010072a:	00 
f010072b:	c7 44 24 04 00 23 11 	movl   $0xf0112300,0x4(%esp)
f0100732:	f0 
f0100733:	c7 04 24 3c 1d 10 f0 	movl   $0xf0101d3c,(%esp)
f010073a:	e8 f8 01 00 00       	call   f0100937 <cprintf>
	cprintf("  end    %08x (virt)  %08x (phys)\n", end, end - KERNBASE);
f010073f:	c7 44 24 08 44 29 11 	movl   $0x112944,0x8(%esp)
f0100746:	00 
f0100747:	c7 44 24 04 44 29 11 	movl   $0xf0112944,0x4(%esp)
f010074e:	f0 
f010074f:	c7 04 24 60 1d 10 f0 	movl   $0xf0101d60,(%esp)
f0100756:	e8 dc 01 00 00       	call   f0100937 <cprintf>
...
f010077c:	c7 04 24 84 1d 10 f0 	movl   $0xf0101d84,(%esp)
f0100783:	e8 af 01 00 00       	call   f0100937 <cprintf>
		ROUNDUP(end - entry, 1024) / 1024);
	return 0;
}
...
f01007a2:	c7 04 24 b0 1d 10 f0 	movl   $0xf0101db0,(%esp)
f01007a9:	e8 89 01 00 00       	call   f0100937 <cprintf>
	cprintf("Type 'help' for a list of commands.\n");
f01007ae:	c7 04 24 d4 1d 10 f0 	movl   $0xf0101dd4,(%esp)
f01007b5:	e8 7d 01 00 00       	call   f0100937 <cprintf>

	cprintf("x=%d y=%d", 3);
f01007ba:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
f01007c1:	00 
f01007c2:	c7 04 24 4e 1c 10 f0 	movl   $0xf0101c4e,(%esp)
f01007c9:	e8 69 01 00 00       	call   f0100937 <cprintf>

	while (1) {
		buf = readline("AbtalELDigital> ");
f01007ce:	c7 04 24 58 1c 10 f0 	movl   $0xf0101c58,(%esp)
f01007d5:	e8 56 0a 00 00       	call   f0101230 <readline>
f01007da:	89 c3                	mov    %eax,%ebx
		if (buf != NULL)
f01007dc:	85 c0                	test   %eax,%eax
f01007de:	74 ee                	je     f01007ce <monitor+0x35>
	char *argv[MAXARGS];
	int i;
...
f01007ec:	eb 0a                	jmp    f01007f8 <monitor+0x5f>
	argv[argc] = 0;
	while (1) {
		// gobble whitespace
...
f01007fd:	74 65                	je     f0100864 <monitor+0xcb>
f01007ff:	0f be c0             	movsbl %al,%eax
f0100802:	89 44 24 04          	mov    %eax,0x4(%esp)
f0100806:	c7 04 24 69 1c 10 f0 	movl   $0xf0101c69,(%esp)
f010080d:	e8 38 0c 00 00       	call   f010144a <strchr>
f0100812:	85 c0                	test   %eax,%eax
f0100814:	75 d8                	jne    f01007ee <monitor+0x55>
			*buf++ = 0;
		if (*buf == 0)
f0100816:	80 3b 00             	cmpb   $0x0,(%ebx)
f0100819:	74 49                	je     f0100864 <monitor+0xcb>
			break;
...
f0100820:	75 16                	jne    f0100838 <monitor+0x9f>
			cprintf("Too many arguments (max %d)\n", MAXARGS);
f0100822:	c7 44 24 04 10 00 00 	movl   $0x10,0x4(%esp)
f0100829:	00 
f010082a:	c7 04 24 6e 1c 10 f0 	movl   $0xf0101c6e,(%esp)
f0100831:	e8 01 01 00 00       	call   f0100937 <cprintf>
f0100836:	eb 96                	jmp    f01007ce <monitor+0x35>
			return 0;
		}
		argv[argc++] = buf;
f0100838:	8d 7e 01             	lea    0x1(%esi),%edi
f010083b:	89 5c b5 a8          	mov    %ebx,-0x58(%ebp,%esi,4)
f010083f:	eb 03                	jmp    f0100844 <monitor+0xab>
		while (*buf && !strchr(WHITESPACE, *buf))
			buf++;
...
f0100849:	74 ab                	je     f01007f6 <monitor+0x5d>
f010084b:	0f be c0             	movsbl %al,%eax
f010084e:	89 44 24 04          	mov    %eax,0x4(%esp)
f0100852:	c7 04 24 69 1c 10 f0 	movl   $0xf0101c69,(%esp)
f0100859:	e8 ec 0b 00 00       	call   f010144a <strchr>
f010085e:	85 c0                	test   %eax,%eax
f0100860:	74 df                	je     f0100841 <monitor+0xa8>
f0100862:	eb 92                	jmp    f01007f6 <monitor+0x5d>
			buf++;
	}
	argv[argc] = 0;
...
f010086e:	0f 84 5a ff ff ff    	je     f01007ce <monitor+0x35>
		return 0;
	for (i = 0; i < NCOMMANDS; i++) {
		if (strcmp(argv[0], commands[i].name) == 0)
f0100874:	c7 44 24 04 1e 1c 10 	movl   $0xf0101c1e,0x4(%esp)
f010087b:	f0 
f010087c:	8b 45 a8             	mov    -0x58(%ebp),%eax
f010087f:	89 04 24             	mov    %eax,(%esp)
f0100882:	e8 65 0b 00 00       	call   f01013ec <strcmp>
f0100887:	85 c0                	test   %eax,%eax
f0100889:	74 1b                	je     f01008a6 <monitor+0x10d>
f010088b:	c7 44 24 04 2c 1c 10 	movl   $0xf0101c2c,0x4(%esp)
f0100892:	f0 
f0100893:	8b 45 a8             	mov    -0x58(%ebp),%eax
f0100896:	89 04 24             	mov    %eax,(%esp)
f0100899:	e8 4e 0b 00 00       	call   f01013ec <strcmp>
f010089e:	85 c0                	test   %eax,%eax
f01008a0:	75 2f                	jne    f01008d1 <monitor+0x138>
	argv[argc] = 0;
	...
	if (argc == 0)
		return 0;
	for (i = 0; i < NCOMMANDS; i++) {
f01008a2:	b0 01                	mov    $0x1,%al
f01008a4:	eb 05                	jmp    f01008ab <monitor+0x112>
		if (strcmp(argv[0], commands[i].name) == 0)
f01008a6:	b8 00 00 00 00       	mov    $0x0,%eax
			return commands[i].func(argc, argv, tf);
f01008ab:	8d 14 00             	lea    (%eax,%eax,1),%edx
f01008ae:	01 d0                	add    %edx,%eax
f01008b0:	8b 4d 08             	mov    0x8(%ebp),%ecx
f01008b3:	89 4c 24 08          	mov    %ecx,0x8(%esp)
f01008b7:	8d 55 a8             	lea    -0x58(%ebp),%edx
f01008ba:	89 54 24 04          	mov    %edx,0x4(%esp)
f01008be:	89 34 24             	mov    %esi,(%esp)
f01008c1:	ff 14 85 04 1e 10 f0 	call   *-0xfefe1fc(,%eax,4)
	cprintf("x=%d y=%d", 3);
...
f01008ca:	78 1d                	js     f01008e9 <monitor+0x150>
f01008cc:	e9 fd fe ff ff       	jmp    f01007ce <monitor+0x35>
		return 0;
	for (i = 0; i < NCOMMANDS; i++) {
		if (strcmp(argv[0], commands[i].name) == 0)
			return commands[i].func(argc, argv, tf);
...
f01008d1:	8b 45 a8             	mov    -0x58(%ebp),%eax
f01008d4:	89 44 24 04          	mov    %eax,0x4(%esp)
f01008d8:	c7 04 24 8b 1c 10 f0 	movl   $0xf0101c8b,(%esp)
f01008df:	e8 53 00 00 00       	call   f0100937 <cprintf>
f01008e4:	e9 e5 fe ff ff       	jmp    f01007ce <monitor+0x35>
		buf = readline("AbtalELDigital> ");
		if (buf != NULL)
			if (runcmd(buf, tf) < 0)
				break;
...
f01008e9:	83 c4 5c             	add    $0x5c,%esp
f01008ec:	5b                   	pop    %ebx
f01008ed:	5e                   	pop    %esi
f01008ee:	5f                   	pop    %edi
f01008ef:	5d                   	pop    %ebp
...
f01008fd:	e8 53 fd ff ff       	call   f0100655 <cputchar>
	*cnt++;
}
f0100902:	c9                   	leave  
f0100903:	c3                   	ret    
...
f010092d:	e8 12 04 00 00       	call   f0100d44 <vprintfmt>
	return cnt;
}
...
f010095a:	89 c6                	mov    %eax,%esi
f010095c:	89 55 e8             	mov    %edx,-0x18(%ebp)
f010095f:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
f0100962:	8b 7d 08             	mov    0x8(%ebp),%edi
	int l = *region_left, r = *region_right, any_matches = 0;
f0100965:	8b 1a                	mov    (%edx),%ebx
f0100967:	8b 01                	mov    (%ecx),%eax
f0100969:	89 45 f0             	mov    %eax,-0x10(%ebp)
f010096c:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)

	while (l <= r) {
f0100973:	eb 77                	jmp    f01009ec <stab_binsearch+0x9b>
		int true_m = (l + r) / 2, m = true_m;
f0100975:	8b 45 f0             	mov    -0x10(%ebp),%eax
f0100978:	01 d8                	add    %ebx,%eax
f010097a:	b9 02 00 00 00       	mov    $0x2,%ecx
f010097f:	99                   	cltd   
f0100980:	f7 f9                	idiv   %ecx
f0100982:	89 c1                	mov    %eax,%ecx

		// search for earliest stab with right type
		while (m >= l && stabs[m].n_type != type)
f0100984:	eb 01                	jmp    f0100987 <stab_binsearch+0x36>
			m--;
f0100986:	49                   	dec    %ecx
	...
	while (l <= r) {
		...
		// search for earliest stab with right type
		while (m >= l && stabs[m].n_type != type)
f0100987:	39 d9                	cmp    %ebx,%ecx
f0100989:	7c 1d                	jl     f01009a8 <stab_binsearch+0x57>
f010098b:	6b d1 0c             	imul   $0xc,%ecx,%edx
f010098e:	0f b6 54 16 04       	movzbl 0x4(%esi,%edx,1),%edx
f0100993:	39 fa                	cmp    %edi,%edx
f0100995:	75 ef                	jne    f0100986 <stab_binsearch+0x35>
f0100997:	89 4d ec             	mov    %ecx,-0x14(%ebp)
			continue;
		}
...
f010099d:	8b 54 16 08          	mov    0x8(%esi,%edx,1),%edx
f01009a1:	3b 55 0c             	cmp    0xc(%ebp),%edx
f01009a4:	73 18                	jae    f01009be <stab_binsearch+0x6d>
f01009a6:	eb 05                	jmp    f01009ad <stab_binsearch+0x5c>
		...
		if (m < l) {	// no match in [l, m]
			l = true_m + 1;
f01009a8:	8d 58 01             	lea    0x1(%eax),%ebx
			continue;
f01009ab:	eb 3f                	jmp    f01009ec <stab_binsearch+0x9b>
		}
		...
		if (stabs[m].n_value < addr) {
			*region_left = m;
f01009ad:	8b 5d e8             	mov    -0x18(%ebp),%ebx
f01009b0:	89 0b                	mov    %ecx,(%ebx)
			l = true_m + 1;
f01009b2:	8d 58 01             	lea    0x1(%eax),%ebx
			l = true_m + 1;
			continue;
		}
		...
		// actual binary search
		any_matches = 1;
f01009b5:	c7 45 ec 01 00 00 00 	movl   $0x1,-0x14(%ebp)
f01009bc:	eb 2e                	jmp    f01009ec <stab_binsearch+0x9b>
		if (stabs[m].n_value < addr) {
			*region_left = m;
			l = true_m + 1;
		} else if (stabs[m].n_value > addr) {
f01009be:	39 55 0c             	cmp    %edx,0xc(%ebp)
f01009c1:	73 15                	jae    f01009d8 <stab_binsearch+0x87>
			*region_right = m - 1;
f01009c3:	8b 45 ec             	mov    -0x14(%ebp),%eax
f01009c6:	48                   	dec    %eax
f01009c7:	89 45 f0             	mov    %eax,-0x10(%ebp)
f01009ca:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
f01009cd:	89 01                	mov    %eax,(%ecx)
			l = true_m + 1;
			continue;
		}
...
f01009d6:	eb 14                	jmp    f01009ec <stab_binsearch+0x9b>
			*region_right = m - 1;
			r = m - 1;
		} else {
...
f01009db:	8b 5d ec             	mov    -0x14(%ebp),%ebx
f01009de:	89 18                	mov    %ebx,(%eax)
			l = m;
			addr++;
f01009e0:	ff 45 0c             	incl   0xc(%ebp)
f01009e3:	89 cb                	mov    %ecx,%ebx
			l = true_m + 1;
			continue;
		}
	       ...
	       int type, uintptr_t addr)
{
	...
	while (l <= r) {
f01009ec:	3b 5d f0             	cmp    -0x10(%ebp),%ebx
f01009ef:	7e 84                	jle    f0100975 <stab_binsearch+0x24>
			l = m;
			addr++;
		}
	}
	...
	if (!any_matches)
f01009f1:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
f01009f5:	75 0d                	jne    f0100a04 <stab_binsearch+0xb3>
		*region_right = *region_left - 1;
f01009f7:	8b 45 e8             	mov    -0x18(%ebp),%eax
f01009fa:	8b 00                	mov    (%eax),%eax
f01009fc:	48                   	dec    %eax
f01009fd:	8b 7d e4             	mov    -0x1c(%ebp),%edi
f0100a00:	89 07                	mov    %eax,(%edi)
f0100a02:	eb 22                	jmp    f0100a26 <stab_binsearch+0xd5>
	else {
		// find rightmost region containing 'addr'
		for (l = *region_right;
f0100a04:	8b 45 e4             	mov    -0x1c(%ebp),%eax
f0100a07:	8b 00                	mov    (%eax),%eax
		     l > *region_left && stabs[l].n_type != type;
f0100a09:	8b 5d e8             	mov    -0x18(%ebp),%ebx
f0100a0c:	8b 0b                	mov    (%ebx),%ecx
	...
	if (!any_matches)
		*region_right = *region_left - 1;
		...
		// find rightmost region containing 'addr'
		for (l = *region_right;
f0100a0e:	eb 01                	jmp    f0100a11 <stab_binsearch+0xc0>
		     l > *region_left && stabs[l].n_type != type;
		     l--)
f0100a10:	48                   	dec    %eax
	...
	if (!any_matches)
		*region_right = *region_left - 1;
		...
		// find rightmost region containing 'addr'
		for (l = *region_right;
f0100a11:	39 c1                	cmp    %eax,%ecx
f0100a13:	7d 0c                	jge    f0100a21 <stab_binsearch+0xd0>
f0100a15:	6b d0 0c             	imul   $0xc,%eax,%edx
		     l > *region_left && stabs[l].n_type != type;
f0100a18:	0f b6 54 16 04       	movzbl 0x4(%esi,%edx,1),%edx
f0100a1d:	39 fa                	cmp    %edi,%edx
f0100a1f:	75 ef                	jne    f0100a10 <stab_binsearch+0xbf>
		     l--)
			/* do nothing */;
		*region_left = l;
f0100a21:	8b 7d e8             	mov    -0x18(%ebp),%edi
f0100a24:	89 07                	mov    %eax,(%edi)
	}
}
...
f0100a34:	83 ec 2c             	sub    $0x2c,%esp
f0100a37:	8b 75 08             	mov    0x8(%ebp),%esi
...
f0100a3d:	c7 03 14 1e 10 f0    	movl   $0xf0101e14,(%ebx)
	info->eip_line = 0;
f0100a43:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
	info->eip_fn_name = "<unknown>";
f0100a4a:	c7 43 08 14 1e 10 f0 	movl   $0xf0101e14,0x8(%ebx)
	info->eip_fn_namelen = 9;
f0100a51:	c7 43 0c 09 00 00 00 	movl   $0x9,0xc(%ebx)
	info->eip_fn_addr = addr;
f0100a58:	89 73 10             	mov    %esi,0x10(%ebx)
	info->eip_fn_narg = 0;
f0100a5b:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)

	// Find the relevant set of stabs
	if (addr >= ULIM) {
f0100a62:	81 fe ff ff 7f ef    	cmp    $0xef7fffff,%esi
f0100a68:	76 12                	jbe    f0100a7c <debuginfo_eip+0x4e>
...
f0100a6a:	b8 a6 71 10 f0       	mov    $0xf01071a6,%eax
f0100a6f:	3d ed 58 10 f0       	cmp    $0xf01058ed,%eax
f0100a74:	0f 86 6b 01 00 00    	jbe    f0100be5 <debuginfo_eip+0x1b7>
f0100a7a:	eb 1c                	jmp    f0100a98 <debuginfo_eip+0x6a>
		...
		// Can't search for user-level addresses yet!
  	        panic("User address");
f0100a7c:	c7 44 24 08 1e 1e 10 	movl   $0xf0101e1e,0x8(%esp)
f0100a83:	f0 
f0100a84:	c7 44 24 04 7f 00 00 	movl   $0x7f,0x4(%esp)
f0100a8b:	00 
f0100a8c:	c7 04 24 2b 1e 10 f0 	movl   $0xf0101e2b,(%esp)
f0100a93:	e8 60 f6 ff ff       	call   f01000f8 <_panic>
	}

	// String table validity checks
	if (stabstr_end <= stabstr || stabstr_end[-1] != 0)
f0100a98:	80 3d a5 71 10 f0 00 	cmpb   $0x0,0xf01071a5
f0100a9f:	0f 85 47 01 00 00    	jne    f0100bec <debuginfo_eip+0x1be>
	...
	lfile = 0;
f0100aa5:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
	rfile = (stab_end - stabs) - 1;
f0100aac:	b8 ec 58 10 f0       	mov    $0xf01058ec,%eax
f0100ab1:	2d 70 20 10 f0       	sub    $0xf0102070,%eax
f0100ab6:	c1 f8 02             	sar    $0x2,%eax
f0100ab9:	69 c0 ab aa aa aa    	imul   $0xaaaaaaab,%eax,%eax
f0100abf:	83 e8 01             	sub    $0x1,%eax
f0100ac2:	89 45 e0             	mov    %eax,-0x20(%ebp)
	stab_binsearch(stabs, &lfile, &rfile, N_SO, addr);
f0100ac5:	89 74 24 04          	mov    %esi,0x4(%esp)
f0100ac9:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
f0100ad0:	8d 4d e0             	lea    -0x20(%ebp),%ecx
f0100ad3:	8d 55 e4             	lea    -0x1c(%ebp),%edx
f0100ad6:	b8 70 20 10 f0       	mov    $0xf0102070,%eax
f0100adb:	e8 71 fe ff ff       	call   f0100951 <stab_binsearch>
	if (lfile == 0)
f0100ae0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
f0100ae3:	85 c0                	test   %eax,%eax
f0100ae5:	0f 84 08 01 00 00    	je     f0100bf3 <debuginfo_eip+0x1c5>
		return -1;

	// Search within that file's stabs for the function definition
	// (N_FUN).
	lfun = lfile;
f0100aeb:	89 45 dc             	mov    %eax,-0x24(%ebp)
	rfun = rfile;
f0100aee:	8b 45 e0             	mov    -0x20(%ebp),%eax
f0100af1:	89 45 d8             	mov    %eax,-0x28(%ebp)
	stab_binsearch(stabs, &lfun, &rfun, N_FUN, addr);
f0100af4:	89 74 24 04          	mov    %esi,0x4(%esp)
f0100af8:	c7 04 24 24 00 00 00 	movl   $0x24,(%esp)
f0100aff:	8d 4d d8             	lea    -0x28(%ebp),%ecx
f0100b02:	8d 55 dc             	lea    -0x24(%ebp),%edx
f0100b05:	b8 70 20 10 f0       	mov    $0xf0102070,%eax
f0100b0a:	e8 42 fe ff ff       	call   f0100951 <stab_binsearch>

	if (lfun <= rfun) {
f0100b0f:	8b 7d dc             	mov    -0x24(%ebp),%edi
f0100b12:	3b 7d d8             	cmp    -0x28(%ebp),%edi
f0100b15:	7f 2e                	jg     f0100b45 <debuginfo_eip+0x117>
		// stabs[lfun] points to the function name
		// in the string table, but check bounds just in case.
		if (stabs[lfun].n_strx < stabstr_end - stabstr)
f0100b17:	6b c7 0c             	imul   $0xc,%edi,%eax
f0100b1a:	8d 90 70 20 10 f0    	lea    -0xfefdf90(%eax),%edx
f0100b20:	8b 80 70 20 10 f0    	mov    -0xfefdf90(%eax),%eax
f0100b26:	b9 a6 71 10 f0       	mov    $0xf01071a6,%ecx
f0100b2b:	81 e9 ed 58 10 f0    	sub    $0xf01058ed,%ecx
f0100b31:	39 c8                	cmp    %ecx,%eax
f0100b33:	73 08                	jae    f0100b3d <debuginfo_eip+0x10f>
			info->eip_fn_name = stabstr + stabs[lfun].n_strx;
f0100b35:	05 ed 58 10 f0       	add    $0xf01058ed,%eax
f0100b3a:	89 43 08             	mov    %eax,0x8(%ebx)
		info->eip_fn_addr = stabs[lfun].n_value;
f0100b3d:	8b 42 08             	mov    0x8(%edx),%eax
f0100b40:	89 43 10             	mov    %eax,0x10(%ebx)
f0100b43:	eb 06                	jmp    f0100b4b <debuginfo_eip+0x11d>
		lline = lfun;
		rline = rfun;
	} else {
		...
		info->eip_fn_addr = addr;
f0100b45:	89 73 10             	mov    %esi,0x10(%ebx)
		lline = lfile;
f0100b48:	8b 7d e4             	mov    -0x1c(%ebp),%edi
		rline = rfile;
	}
	// Ignore stuff after the colon.
	info->eip_fn_namelen = strfind(info->eip_fn_name, ':') - info->eip_fn_name;
f0100b4b:	c7 44 24 04 3a 00 00 	movl   $0x3a,0x4(%esp)
f0100b52:	00 
f0100b53:	8b 43 08             	mov    0x8(%ebx),%eax
f0100b56:	89 04 24             	mov    %eax,(%esp)
f0100b59:	e8 0d 09 00 00       	call   f010146b <strfind>
f0100b5e:	2b 43 08             	sub    0x8(%ebx),%eax
f0100b61:	89 43 0c             	mov    %eax,0xc(%ebx)
	...
	while (lline >= lfile
f0100b64:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
f0100b67:	6b c7 0c             	imul   $0xc,%edi,%eax
f0100b6a:	05 70 20 10 f0       	add    $0xf0102070,%eax
f0100b6f:	eb 06                	jmp    f0100b77 <debuginfo_eip+0x149>
	       && stabs[lline].n_type != N_SOL
	       && (stabs[lline].n_type != N_SO || !stabs[lline].n_value))
		lline--;
f0100b71:	83 ef 01             	sub    $0x1,%edi
f0100b74:	83 e8 0c             	sub    $0xc,%eax
	// Search backwards from the line number for the relevant filename
	// stab.
	// We can't just use the "lfile" stab because inlined functions
	// can interpolate code from a different file!
...
f0100b79:	7c 33                	jl     f0100bae <debuginfo_eip+0x180>
	       && stabs[lline].n_type != N_SOL
f0100b7b:	0f b6 50 04          	movzbl 0x4(%eax),%edx
f0100b7f:	80 fa 84             	cmp    $0x84,%dl
f0100b82:	74 0b                	je     f0100b8f <debuginfo_eip+0x161>
	       && (stabs[lline].n_type != N_SO || !stabs[lline].n_value))
f0100b84:	80 fa 64             	cmp    $0x64,%dl
f0100b87:	75 e8                	jne    f0100b71 <debuginfo_eip+0x143>
f0100b89:	83 78 08 00          	cmpl   $0x0,0x8(%eax)
f0100b8d:	74 e2                	je     f0100b71 <debuginfo_eip+0x143>
		lline--;
	if (lline >= lfile && stabs[lline].n_strx < stabstr_end - stabstr)
f0100b8f:	6b ff 0c             	imul   $0xc,%edi,%edi
f0100b92:	8b 87 70 20 10 f0    	mov    -0xfefdf90(%edi),%eax
f0100b98:	ba a6 71 10 f0       	mov    $0xf01071a6,%edx
f0100b9d:	81 ea ed 58 10 f0    	sub    $0xf01058ed,%edx
f0100ba3:	39 d0                	cmp    %edx,%eax
f0100ba5:	73 07                	jae    f0100bae <debuginfo_eip+0x180>
		info->eip_file = stabstr + stabs[lline].n_strx;
f0100ba7:	05 ed 58 10 f0       	add    $0xf01058ed,%eax
f0100bac:	89 03                	mov    %eax,(%ebx)


	// Set eip_fn_narg to the number of arguments taken by the function,
	// or 0 if there was no containing function.
	if (lfun < rfun)
f0100bae:	8b 4d dc             	mov    -0x24(%ebp),%ecx
f0100bb1:	8b 75 d8             	mov    -0x28(%ebp),%esi
		for (lline = lfun + 1;
...
f0100bb4:	b8 00 00 00 00       	mov    $0x0,%eax
	...
	// or 0 if there was no containing function.
	if (lfun < rfun)
f0100bb9:	39 f1                	cmp    %esi,%ecx
f0100bbb:	7d 42                	jge    f0100bff <debuginfo_eip+0x1d1>
		for (lline = lfun + 1;
f0100bbd:	8d 51 01             	lea    0x1(%ecx),%edx
f0100bc0:	6b c1 0c             	imul   $0xc,%ecx,%eax
f0100bc3:	05 70 20 10 f0       	add    $0xf0102070,%eax
f0100bc8:	eb 07                	jmp    f0100bd1 <debuginfo_eip+0x1a3>
		     lline < rfun && stabs[lline].n_type == N_PSYM;
		     lline++)
			info->eip_fn_narg++;
f0100bca:	83 43 14 01          	addl   $0x1,0x14(%ebx)
	// Set eip_fn_narg to the number of arguments taken by the function,
	// or 0 if there was no containing function.
	if (lfun < rfun)
		for (lline = lfun + 1;
...
f0100bd3:	74 25                	je     f0100bfa <debuginfo_eip+0x1cc>
f0100bd5:	83 c0 0c             	add    $0xc,%eax
		     lline < rfun && stabs[lline].n_type == N_PSYM;
f0100bd8:	80 78 04 a0          	cmpb   $0xa0,0x4(%eax)
f0100bdc:	74 ec                	je     f0100bca <debuginfo_eip+0x19c>
		     lline++)
			info->eip_fn_narg++;

	return 0;
f0100bde:	b8 00 00 00 00       	mov    $0x0,%eax
f0100be3:	eb 1a                	jmp    f0100bff <debuginfo_eip+0x1d1>
  	        panic("User address");
	}
...
f0100bea:	eb 13                	jmp    f0100bff <debuginfo_eip+0x1d1>
f0100bec:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
f0100bf1:	eb 0c                	jmp    f0100bff <debuginfo_eip+0x1d1>
	// Search the entire set of stabs for the source file (type N_SO).
	lfile = 0;
	rfile = (stab_end - stabs) - 1;
	stab_binsearch(stabs, &lfile, &rfile, N_SO, addr);
...
f0100bf8:	eb 05                	jmp    f0100bff <debuginfo_eip+0x1d1>
		for (lline = lfun + 1;
		     lline < rfun && stabs[lline].n_type == N_PSYM;
		     lline++)
			info->eip_fn_narg++;
...
f0100bff:	83 c4 2c             	add    $0x2c,%esp
f0100c02:	5b                   	pop    %ebx
f0100c03:	5e                   	pop    %esi
f0100c04:	5f                   	pop    %edi
f0100c05:	5d                   	pop    %ebp
...
f0100ce8:	0f be 80 39 1e 10 f0 	movsbl -0xfefe1c7(%eax),%eax
...
f0100dcf:	ff 24 95 e0 1e 10 f0 	jmp    *-0xfefe120(,%edx,4)
...
f0100eab:	c7 44 24 08 5a 1e 10 	movl   $0xf0101e5a,0x8(%esp)
f0100eb2:	f0 
...
f0100edb:	b8 4a 1e 10 f0       	mov    $0xf0101e4a,%eax
...
f0101244:	c7 04 24 5a 1e 10 f0 	movl   $0xf0101e5a,(%esp)
f010124b:	e8 e7 f6 ff ff       	call   f0100937 <cprintf>

	i = 0;
	echoing = iscons(0);
f0101250:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
f0101257:	e8 1a f4 ff ff       	call   f0100676 <iscons>
...
f010125e:	be 00 00 00 00       	mov    $0x0,%esi
	...
	while (1) {
		c = getchar();
f0101263:	e8 fd f3 ff ff       	call   f0100665 <getchar>
...
f0101272:	c7 04 24 60 20 10 f0 	movl   $0xf0102060,(%esp)
f0101279:	e8 b9 f6 ff ff       	call   f0100937 <cprintf>
			return NULL;
...
f010129e:	e8 b2 f3 ff ff       	call   f0100655 <cputchar>
			i--;
...
f01012bc:	e8 94 f3 ff ff       	call   f0100655 <cputchar>
			buf[i++] = c;
...
f01012e1:	e8 6f f3 ff ff       	call   f0100655 <cputchar>
			buf[i] = 0;
